...
namespace DigitalRuby.RainMaker
{
    public class RainScript : BaseRainScript
    {
		...
		public float mistX = 0.0f;
		public float mistZ = 0.0f;
		public float mistScaleX = 1.0f;
		public float mistScaleZ = 1.0f;
            ...
            if (RainFallParticleSystem != null)
            {
                if (FollowCamera)
                {
                    ...
                    if (RainMistParticleSystem != null)
                    {
						...
						// RainMistParticleSystem.transform.
						// RainMistParticleSystem.transform.scale.x *= mistScaleX;
						// RainMistParticleSystem.transform.scale.z *= mistScaleZ;
                    }
                }
                else
                {
